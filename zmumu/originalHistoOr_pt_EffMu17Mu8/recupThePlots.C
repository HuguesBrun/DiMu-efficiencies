...
TString thePath = "/afs/cern.ch/user/a/agrebeny/CMSSW_7_4_7/src/MuonAnalysis/TagAndProbe/test/zmumu/originalHistoOr_pt_EffMu17Mu8";
TString theOutFileName = "output_EffMu17Mu8_pt.root";
