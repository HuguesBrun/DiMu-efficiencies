...
TString thePath = "/afs/cern.ch/user/a/agrebeny/CMSSW_7_4_7/src/MuonAnalysis/TagAndProbe/test/zmumu/originalHistoNew";
TString theOutFileName = "output_data1nodz.root";
