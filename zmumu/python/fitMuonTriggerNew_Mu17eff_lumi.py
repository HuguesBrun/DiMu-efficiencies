...
Template = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    Variables = cms.PSet(
        ...
        lumi = cms.vstring("Luminosity", "0", "2000", ""),
...
PT_ETA_BINS = cms.PSet(
                     ...
                     #    abseta = cms.vdouble(0, 0.9, 1.2, 2.1, 2.4), # don't forget to change it back!!!!!!!!!!!!!!!
...
'file:/afs/cern.ch/user/a/agrebeny/eos/cms/store/group/phys_smp/VJets/Bonzai13TeVoutput/tmp/tnpZ_theTreeCleaned_MC_eff_new.root' # MC reweighted
