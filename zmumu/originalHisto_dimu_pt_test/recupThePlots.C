...
TString thePath = "/afs/cern.ch/user/a/agrebeny/CMSSW_7_4_7/src/MuonAnalysis/TagAndProbe/test/zmumu/originalHisto_dimu_pt_test";
TString theOutFileName = "output_data_dimu_pt_test.root";
