...
TString thePath = "/afs/cern.ch/user/a/agrebeny/CMSSW_7_4_7/src/MuonAnalysis/TagAndProbe/test/zmumu/originalHistoOr_pt_EffMu17TkMu8";
TString theOutFileName = "output_EffMu17TkMu8_pt.root";
