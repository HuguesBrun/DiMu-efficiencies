...
void  eff_EffMu17TkMu8_pt(){

 gROOT->SetStyle("Plain");
 gStyle -> SetErrorX(0);

   //TFile *fdataeff= new TFile("output_EffMu17TkMu8_pt.root"); // data
   TFile *fdataeff= new TFile("output_EffMu17TkMu8_mc_pt.root"); // MC
...
TH1F  *hrEffA = (TH1F*)hr2DRefRormula -> Clone();
 ...
 //  t->DrawLatex(0.33,0.95, "1 - (1 -#epsilon_{#mu 17 on #mu_1})*(1 -#epsilon_{#mu 17 on #mu_2}) " );
   t->DrawLatex(0.33,0.95, "1 - (1 -#epsilon_{i})*(1 -#epsilon_{k}) ; (MC)" );  // data or MC
...
fdataeff->ls();
//  tag_abseta_bin0
TGraphAsymmErrors  *histo1D = (TGraphAsymmErrors*) fdataeff->Get("EffMu17TkMu8_pt_eta_pt_PLOT_tag_pt_bin0_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
...
//  tag_abseta_bin1
TGraphAsymmErrors  *histo1Db1 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17TkMu8_pt_eta_pt_PLOT_tag_pt_bin1_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
...
cout << "--------------" << "\n";
//  tag_abseta_bin2
TGraphAsymmErrors  *histo1Db2 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17TkMu8_pt_eta_pt_PLOT_tag_pt_bin2_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
...
cout << "--------------" << "\n";
//  tag_abseta_bin3
TGraphAsymmErrors  *histo1Db3 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17TkMu8_pt_eta_pt_PLOT_tag_pt_bin3_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
...
cout << "--------------" << "\n";
//  tag_abseta_bin4
TGraphAsymmErrors  *histo1Db4 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17TkMu8_pt_eta_pt_PLOT_tag_pt_bin4_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
...
cout << "--------------" << "\n";
//  tag_abseta_bin5
TGraphAsymmErrors  *histo1Db5 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17TkMu8_pt_eta_pt_PLOT_tag_pt_bin5_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
...
/////////////////////////////////////////////////////////////
 ...
 //  c-> Print("eff_EffMu17TkMu8_data_pt.pdf");   // data
     c-> Print("eff_EffMu17TkMu8_MC_pt.pdf");     // MC
