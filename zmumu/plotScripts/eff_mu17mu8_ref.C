...
// TFile *f= new TFile("Efficiency1.root");
   TFile *fdatadz= new TFile("../TnP_MuonID_signal_mc_Mu17Mu8_pt_eta.root");
...
TH1F  *histo1D = (TH1F*) fdatadz->Get("abseta_PLOT_tag_abseta_bin0_&_Mu17Eff_pass_&_Tight2012_pass");
