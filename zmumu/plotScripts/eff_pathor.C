...
void  eff_pathor(){
 ...
 gStyle -> SetErrorX(0);
   ...
   TFile *fdataeff= new TFile("output_mcOr.root");
 //    TFile *fdataeff= new TFile("output_dataOr.root");
...
/*
TFile g("reftrigger_MC_new.root", "RECREATE"); //create file
   hr2DRefRormula -> SetName("hrEffMC");
...
/*  // DATA
TFile g("effDatapathOr_new.root", "RECREATE"); //create file
   hrEffA -> SetName("hrEffData");
   hrEffA -> Write();
*/
  // MC
TFile g("effMCpathOr_new.root", "RECREATE"); //create file
