...
void  eff_pathorMu20(){
 ...
 TFile *fdataeff= new TFile("output_MCOrMu20.root");
...
float Bins[3]={0, 1.2, 2.4};
TH1D *hr1DTot    = new TH1D("hr1DTot",  "", 2, Bins);
...
double etabin[3] = {0, 1.2, 2.4};
TH2F *hr2DRefRormula  = new TH2F("heta1eta2","", 2, etabin, 2, etabin);
...
fdataeff->ls();
//  tag_abseta_bin0
TGraphAsymmErrors  *histo1D = (TGraphAsymmErrors*) fdataeff->Get("pathOrMu20_pt_eta_abseta_PLOT_tag_abseta_bin0_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
...
cout << "--------------" << "\n";
//  tag_abseta_bin1
TGraphAsymmErrors  *histo1Db1 = (TGraphAsymmErrors*) fdataeff->Get("pathOrMu20_pt_eta_abseta_PLOT_tag_abseta_bin1_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
...
/*
//  tag_abseta_bin2
TGraphAsymmErrors  *histo1Db2 = (TGraphAsymmErrors*) fdataeff->Get("pathOrMu20_pt_eta_abseta_PLOT_tag_abseta_bin2_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
...
cout << "--------------" << "\n";
//  tag_abseta_bin3
TGraphAsymmErrors  *histo1Db3 = (TGraphAsymmErrors*) fdataeff->Get("pathOrMu20_pt_eta_abseta_PLOT_tag_abseta_bin3_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
...
double etabin[3] = {0, 1.2, 2.4};
TH2F *heta1eta2  = new TH2F("heta1eta2","", 2, etabin, 2, etabin);
...
TH1F  *hrEffB = (TH1F*)heta1eta2 -> Clone(); 
   t->SetTextColor(1);
   t->SetTextSize(0.04);
   t->DrawLatex(0.02,0.95, "((Mu17Mu8||Mu17TkMu8||Mu20||TkMu20)&&HLT_Mu17)/HLT_Mu17" );
//////////////////////////////////////////////////
...
TFile g("effMCpathOrMu20_new.root", "RECREATE"); //create file
   hrEffA -> SetName("hrEffMC");
   hrEffA -> Write();
...
/////////////////////////////////////////////////////////////
   ...
   c-> Print("eff_pathOrMu20_mc_new.pdf"); 
