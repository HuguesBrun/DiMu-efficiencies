...
TString thePath = "/afs/cern.ch/user/a/agrebeny/CMSSW_7_4_7/src/MuonAnalysis/TagAndProbe/test/zmumu/originalHistoOr_pt_pathOr";
TString theOutFileName = "output_pathOr_mc_pt.root";
