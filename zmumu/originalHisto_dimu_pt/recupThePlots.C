...
TString thePath = "/afs/cern.ch/user/a/agrebeny/CMSSW_7_4_7/src/MuonAnalysis/TagAndProbe/test/zmumu/originalHisto_dimu_pt";
TString theOutFileName = "output_mc_dimu_pt.root";
